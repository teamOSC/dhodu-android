...
public class WashingMachineView extends LinearLayout {
    ...
    public class TopView extends View {
        ...
        public TopView(Context context, AttributeSet attrs) {
            ...
            LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, mTopviewHeight);
    ...
    public class BottomView extends View {
        ...
        public BottomView(Context context, AttributeSet attrs) {
            super(context, attrs);
            LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, mBottomviewHeight);
